...
namespace SolexMobileApp.Views.Modules
{
    ...
    public partial class ListHistoricalDeliveredsPage : ContentPage
    {
        // Lista de guías
        ...
        public ListHistoricalDeliveredsPage(bool loadData = false)
        {
            InitializeComponent();
        ...
        public void LoadDataLocal()
        {
            ...
            listPlanillaItems = App.GuiaDatabase.GetAllGuias(true, userId: Constants.CurrentUser.IdSolex);
            ...
            if (listPlanillaItems.Count == 0)
            {
                ...
                Lbl_ListHistoricalDelivereds.Text = "Este dispositivo no registra tareas realizadas.";
                // Mostramos el mensaje de cero registros
                Lbl_ListHistoricalDelivereds.IsVisible = true;
            } 
            else
            {
